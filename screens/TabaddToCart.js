...
export default class AddToCart extends Component {
  ...
  render() {
    if (this.state.EmptyCart) {
      ...
      ///  console.log('totalcost........222211......', data);
      ...
      return totalcost > 0 ? (
        <SafeAreaView style={styles.container}>
          <View style={{flex: 1, padding: 1, marginTop: 30}}>
...
const Footer = data => {
  //let finalFooterData = JSON.parse(data);

  //console.log("localcart..", data.data.localcart);
  // console.log("=========ssss=====", data.data.prop.route.params.StoreID)
  ...
  if (typeof data.data.data === 'undefined') {
    ...
    console.log('===========ubk=2222===========', JSON.stringify(data));
    console.log('===========ubk=2 prop===========', {
      StoreID: data.data.Mystate.data.businessId,
      localcart: data.data.localcart,
      acceptsCOD: data.data.Mystate.acceptsCOD,
      requireSlot: data.data.Mystate.acceptsCOD,
    });
