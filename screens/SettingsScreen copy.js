    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profile}> 
              ...
              style={[globalstyle.avaterProfileImage,{marginTop:40}]}
            />
               <Text style={{color:globalcolor.SeconderColor,fontFamily:globalcolor.Font}}>{UserData.firstName} {UserData.lastName}</Text>
          </View>
          <TouchableOpacity 
          ...
          <View style={globalstyle.ListCategoryrow}>
                    <View style={globalstyle.ListFirstCategoryIcon}>
                       <FontAwesome name="share-alt" color={globalcolor.PrimaryColor} size={18} />
                    </View>
                     <View style={globalstyle.ListBody}>
