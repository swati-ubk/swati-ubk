  ...
  cutAdd = async (product, count) => {
    ...
    /// await AsyncStorage.removeItem("addToCart");
      ...
      if (cartData === null || cartData === undefined) {
       ...
       // console.log('nooooooo1111111155', veri_id);
        data_obj = [{
          name: product.name,
      ...
      //console.log("sddddd--------",data_obj)
      await AsyncStorage.setItem("addToCart", JSON.stringify(data_obj));
     // console.log("sddddd--2------",this.state.localcart)
      
      //console.log('oooooo----', this.state.localcart[0]);
     ...
     /// console.log("sdsdssdsdsss",JSON.stringify(cartData));
      let data2 = JSON.parse(cartData);
     /// console.log("dfdfdfddf",""+product.id);
 // var dattttt= data2.filter(item => item.id === product.id)

 /// console.log("sdsdsdsdsds---33-",dattttt);
      var indexx = data2.findIndex(obj => obj.id === product.id);
      //arrr.splice(0)
      ...
      await AsyncStorage.setItem("addToCart", JSON.stringify(data2));
     // console.log("sdsdsdsdsds----",indexx);
      //data2[indexx].priduce_v.count = count;

     // delete data2[indexx];

     ///data2.splice(indexx, 1);
      //console.log("sdsdsdsdsds3333----",data2[indexx].variants);
    //  data2[indexx].variants.veri_id = count;
    ///console.log("sddddd22--------",data2.removeItem)

      //let data3 = JSON.parse(data2);
     
    //console.log("sddddd--------",data2)
   //
    }
  }
      ...
      //       console.log("sfsdf44444444-----"+product.id,data_obj);
      //       await AsyncStorage.setItem("addToCart", JSON.stringify(data_obj));
      //       this.importData();
      //     }
  ...
  checkCart = data => {
    try {
      ...
      console.log("aaaaaaaaaaaaaaaaa",data.variants.length)
