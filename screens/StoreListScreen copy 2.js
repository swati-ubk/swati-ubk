 ...
 */
 ...
 export default class StoreList extends React.Component {
     ...
     fetchCats() {
         ...
         fetch('http://api.beta.diskounto.com/search/business?category='+this.props.route.params.Catvalue+'&lat=25.5940947&lng=85.1375645&formattedAddress=Patna%2C%20Bihar%2C%20India&city=Patna&state=BR&limit=20&skip=')
             .then(res => res.json())
             .then(resJson => {
               //console.log(resJson)
