...
export default class ProductListScreen extends React.Component {
  constructor(props) {
    super(props);
    console.log('productListProbs...', this.props);
    this.state = {
      data: [],
      refreshing: false,
        ...
        <SafeAreaView style={{ flex: 1, zIndex: 2, marginTop: 40, marginLeft: 5, marginRight: 5 }}>
          ...
          <View style={styles.footer}>
            ...
            <View style={styles.footerItem2}>
              <TouchableOpacity
                onPress={() => { this.props.navigation.navigate('AddToCart', { StoreID: this.state.StoreID, acceptsCOD: this.state.acceptsCOD, requireSlot: this.state.requireSlot }) }}>
